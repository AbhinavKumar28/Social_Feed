...
function Left({ left }: Leftmenu): JSX.Element {
  ...
  return (
    <>
      ...
      {left === "profile" && (
        <>
          <button id="skip-link-target-content-1" className="column-back-button" type="button">
            <svg
          ...
          <div className="elephant-container">
            <img className="elephant-image" src={elephant} alt="" />
          </div>
          <div className="edit-profile">
            <button>Edit profile</button>
            <button
              type="button"
              aria-label="Share @ak_57's profile"
              aria-hidden="false"
              title="Share @ak_57's profile"
              className="optional icon-button"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
          ...
          <div className="post-border">
            ...
            <div className="compose-form__upload-button">
              <div>
                <button
                  type="button"
                  aria-label="Add images, a video or an audio file"
                  aria-hidden="false"
                  title="Add images, a video or an audio file"
                  className="compose-form__upload-button-icon icon-button inverted"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="20"
                ...
                <button
                  ...
                  aria-hidden="false"
                  title="Add a poll"
                  className="compose-form__poll-button-icon  icon-button inverted"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="20"
                ...
                <button
                  ...
                  aria-hidden="false"
                  aria-controls="cw-spoiler-input"
              ...
              <div>
                <span className="post-500">500</span>
